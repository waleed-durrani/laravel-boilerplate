@if(isset($errors) && $errors->any())
    <x-utils.alert color="red" class="sm:rounded-md sm:mt-5">
        <x-slot name="icon">
...
@if(session()->get('flash_success'))
    <x-utils.alert color="green" class="sm:rounded-md sm:mt-5">
        <x-slot name="icon">
            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
...
@if(session()->get('flash_warning'))
    <x-utils.alert color="yellow" class="sm:rounded-md sm:mt-5">
        {{ session()->get('flash_warning') }}
    </x-utils.alert>
@endif

@if(session()->get('flash_info') || session()->get('flash_message'))
    <x-utils.alert color="blue" class="sm:rounded-md sm:mt-5">
